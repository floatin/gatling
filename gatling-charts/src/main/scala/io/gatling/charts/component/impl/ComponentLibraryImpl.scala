...
class ComponentLibraryImpl extends ComponentLibrary {
	...
	def getGroupDurationChartComponent(title: String, runStart: Long, durationsSuccess: Series[IntRangeVsTimePlot], durationsFailure: Series[IntRangeVsTimePlot]): Component = throw new UnsupportedOperationException
	def getGroupDetailsDurationDistributionChartComponent(title: String, durationsSuccess: Series[IntVsTimePlot], durationsFailure: Series[IntVsTimePlot]): Component = throw new UnsupportedOperationException
}
