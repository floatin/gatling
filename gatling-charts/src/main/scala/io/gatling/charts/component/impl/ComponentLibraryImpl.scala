...
class ComponentLibraryImpl extends ComponentLibrary {
	...
	def getGroupDurationChartComponent(title: String, containerId: String, runStart: Long, durationsSuccess: Series[IntRangeVsTimePlot], durationsFailure: Series[IntRangeVsTimePlot]): Component = throw new UnsupportedOperationException
